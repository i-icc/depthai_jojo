...
parser.add_argument('-fn', '--file-num', type=int, help="Out file name number")
...
def show(frame):
    global keypoints_list, detected_keypoints, personwiseKeypoints, nm, file_num
    ...
    if keypoints_list is not None and detected_keypoints is not None and personwiseKeypoints is not None:
        ...
        with open(f"./train_data/angle/{file_num}.txt", "w") as f:
            print(angles)
